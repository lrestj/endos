...
abbr ngc --set-cursor -- "git commit -a -m \"%\""
abbr ppp "git --git-dir=$HOME/.cfg.git/ --work-tree=$HOME push -u github arch && git --git-dir=$HOME/.cfg.git/ --work-tree=$HOME push gitlab arch"
